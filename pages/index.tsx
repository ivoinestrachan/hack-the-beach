...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      >
        <source
          src="https://cloud-ajdh27epl-hack-club-bot.vercel.app/0underwater_ocean_waves.mp4"
          type="video/mp4"
        />
      ...
      <div className="flex items-center justify-center h-screen relative z-10">
        <div className="text-center">
          <div className="font-extrabold sm:text-[60px] text-[40px] text-yellow-300">
            Hack The Beach
          </div>
          <a href="#hack">
            <button className="text-center bg-blue-500 py-5 px-20 rounded-[8px] text-white text-[20px] font-bold">
              Dive In
            </button>
          </a>
        </div>
